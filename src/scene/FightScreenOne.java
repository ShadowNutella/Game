...
public class FightScreenOne extends Scene {
    ...
    public void update() {
        ...
        // Interval of the Enemies shooting at the Players
        shootTimer++;
        shootTimer %= 180;
        if (shootTimer == 100) {
        ...
        // Method win is called if Enemies have 0 or less HP.
    ...
    // Creates an Array with all Enemies so Damage etc. can be easier applied to both/all Enemies.
